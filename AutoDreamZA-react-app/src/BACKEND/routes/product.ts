...
//This GET scrapes all of the products from the website and saves it to the database
...
// this GET gets all of the products from the database and then displays it on the website
